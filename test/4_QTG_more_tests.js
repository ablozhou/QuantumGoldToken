...
let QTG;
// var accounts={};
// change this account to the account need test.
// accounts[0] = "0xc85f48a3266f5db98d2dec18f44d91eed384e240"; //Contract creator
// accounts[1] = "0xade22e54b4016256b7c0971e027e537327ee6e44"; //receiver
// accounts[2] = "0x20369187c6b8fef29632752aab863e744215866e"; //user
// accounts[3] = "0xd7f313f0589e8105f818eb79ead6f41ff154af0c"; //Investors
// accounts[4] = "0x8f34cc670dc446a514dea7c55635d2df625bb6f3"; //Public Contributor
// accounts[5] = "0x600de3c2ab4faec1d1cc092d52ee14ee2264c28b"; //WALLET_ACCOUNT
...
contract('QuantumGoldToken', function (accounts) {
  ...
  it('accounts balance',async()=>{
      arr.forEach(async(i)=> {
          const b = await QTG.balanceOf.call(accounts[i]);
          console.log("account %d:%d,%s",i,b.toNumber(),accounts[i])
